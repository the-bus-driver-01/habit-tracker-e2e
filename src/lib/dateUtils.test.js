...
import { getFirstDayOfMonth, getLastDayOfMonth, getIsoDay, addDays, getWeekStart, getWeekEnd, getWeeksForMonth, isSameDay, isToday, getMonthYearString, getDayLabels, getPreviousMonth, getNextMonth, } from "./dateUtils";
describe("dateUtils", () => {
    ...
    describe("getWeeksForMonth", () => {
        ...
        it("should have all days of the current month", () => {
            ...
            const marchDates = allDates.filter((d) => d.getMonth() === 2 && d.getFullYear() === 2024);
